...
export const SidebarUpdateItem: FC<SidebarUpdateItemProps> = ({
    ...
    if (isOpen) {
      const fetchData = async () => {
        ...
        const fetchDataFunction =
          fetchDataFunctions[contentType as keyof typeof fetchDataFunctions]
  ...
  const updateFunctions = {
    ...
    assistants: async (
      ...
      const updatedAssistant = await updateAssistant(assistantId, updateState)
      await handleWorkspaceUpdates(
        startingWorkspaces,
        selectedWorkspaces,
        assistantId,
      ...
      >
        <div className="grow overflow-auto">
          ...
          <div className="mt-4 space-y-3">
            ...
            {contentType === "teams" || !renderState
              ? null
              : renderInputs(
                  renderState[contentType as keyof typeof renderState]
                )}
          </div>
        </div>
